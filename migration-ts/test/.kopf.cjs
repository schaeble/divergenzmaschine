...
for (const w of [
  ...
  "ein Schulm\xE4dchen, das Karten f\xE4lscht",
  "die W\xE4chterin, mit einem fremden Koffer",
  "Tom",
  "eine Nonne, die die Welt bereist hat, kurz vor dem Aufbruch"
])
  console.log(JSON.stringify(w).padEnd(60), "\u2192", JSON.stringify(personKopf(w)));
