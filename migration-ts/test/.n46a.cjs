...
console.log("\u2500\u2500 dachOrt, F\xE4lle aus Nr. 46 \u2500\u2500");
for (const o of [
  "hoch in der Luft",
  "in einem Hochhaus ohne Erdgeschoss",
  "auf der Schafsweide",
  "in Island",
  "zu einer Zeit, die niemand z\xE4hlt",
  "in einem Beichtstuhl",
  "im Wasser",
  "in der Toskana"
])
  console.log(`   ${JSON.stringify(o).padEnd(42)} \u2192 ${JSON.stringify(dachOrt(o))}`);
