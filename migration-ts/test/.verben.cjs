...
ist("reichen ist ein Verb, kein Diminutiv", hatFinitesVerb("die Perlen reichen f\xFCr ein Vorderteil"), true);
ist("gilt (nicht in der Tabelle)", deriveAtom("die Auskunft gilt r\xFCckwirkend").typ, "hauptsatz");
ist("geh\xF6rt", deriveAtom("die Nacht geh\xF6rt den Wachen").typ, "hauptsatz");
ist("ger\xE4t", deriveAtom("das Experiment ger\xE4t au\xDFer Kontrolle").typ, "hauptsatz");
ist("h\xF6ren (Plural)", deriveAtom("die Nachbarn h\xF6ren jedes Wort durch die Wand").typ, "hauptsatz");
