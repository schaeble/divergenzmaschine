...
console.log("\u2500\u2500 1 \xB7 Faktenkasten aus Nr. 46 \u2500\u2500");
var FK = "Faktenkasten \xB7 Neu: 3.660 Haushalte \xB7 Ausdehnung: 278 Meter \xB7 1944: der Anfang \xB7 im Fr\xFChjahr: die erste Meldung.";
console.log("   Ger\xFCst erkannt?", GERUEST_ZEILE.test(FK));
console.log("   Reinigung:", JSON.stringify(corpusSanitize(FK)));
console.log("   im Absatz (ohne Zeilenumbruch davor):", JSON.stringify(corpusSanitize("Ein Geruch aus der Kindheit. " + FK)));
console.log("\n\u2500\u2500 2 \xB7 der abgeschnittene Lynar-Satz aus Nr. 46 \u2500\u2500");
console.log("   ", JSON.stringify(formeWas("Rochus zu Lynar geboren, der insbesondere durch Bauten im Dienst deutscher F\xFCrsten")));
console.log("\n\u2500\u2500 3 \xB7 Meldung: der Jordanien-Satz ohne Verb \u2500\u2500");
console.log("   ", JSON.stringify(formeWas("Zur Beendigung des Jordanischen B\xFCrgerkrieges zwischen jordanischen Sicherheitskr\xE4ften und pal\xE4stinensischen Milizen sowie deren Unterst\xFCtzern aus Syrien")));
