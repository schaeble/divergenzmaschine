...
var P = [
  "Fl\xFCsse als Adern. Fl\xFCsse als Adern. Der Rest bleibt.",
  "Aus Symmetrie wird Unterschied \u2014 Aus Symmetrie wird Unterschied. Weiter.",
  "Eine Hand voller Schl\xFCssel, die singen. Eine Hand voller Schl\xFCssel, die singen."
];
for (const p of P) {
  console.log("roh :", p);
  console.log("rein:", entferneDubletten(p));
}
console.log("\n\xFCber postProcessText:");
console.log(postProcessText(P[0], { form: "prose", tone: "neutral" }));
