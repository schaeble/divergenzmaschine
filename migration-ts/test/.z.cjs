...
var init_waechterStatistik = __esm({
  "src/features/waechterStatistik.ts"() {
    ...
    EBENE2 = /* @__PURE__ */ new Set([
      ...
      "schliff_adjektivKongruenz",
      "schliff_relativKongruenz",
    ...
    ZAEHLER_NAMEN = {
      ...
      schliff_adjektivKongruenz: "Schliff \xB7 Adjektiv-Kongruenz am Satzanfang",
      schliff_relativKongruenz: "Schliff \xB7 Relativpronomen nach Pr\xE4position",
