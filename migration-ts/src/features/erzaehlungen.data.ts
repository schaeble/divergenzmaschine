...
// tragen je eine Bauform (folge → SCHLAGFOLGEN), die als Schlagfolge in die
// Struktur „Dramaturgie" durchschlägt, und sind so geschrieben, dass die
// Ableitung (preset2AusText) je Geschichte
