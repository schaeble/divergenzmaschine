...
export function buildPreset2Prompt(inspiration: string, seed?: string, kontext?: VierW | null): string {
  ...
  return k + seedPart + 'Du erstellst ein "Preset 2.0" für einen prozeduralen, deutschsprachigen Kreativ-Textgenerator (Divergenzmaschine). '
    ...
    + "Nominal-Kategorien nur rund 6. Satzartige Eintraege deshalb bei mindestens sieben Woertern.\n\n"
    + "MOTIVE MUESSEN ALLEIN STEHEN KOENNEN: Jedes Motiv ist eine Nominalphrase mit Artikel und "
    + "eigenem Kopf, am besten mit Relativsatz. Nicht \"Brot und Ketten\", nicht \"Kanaele unter der "
    + "Stadt\" — solche Bruchstuecke haben keinen Kopf, an den der Generator anschliesst. Gemessen: "
    + "Ein Preset mit zehn davon brach in 33 von 60 Laeufen mitten im Text ab, Median 90 statt 400 "
    + "Woerter. Nach dem Umschreiben 387.\n\n"
    + "Die Zahl 120 ist kein Ziel fuer sich: Sobald die Wortzahl bekannt ist, sagt die Eintragszahl "
    + "nichts mehr voraus (r = -0,04 ueber 23 Presets). 90 lange Eintraege sind so gut wie 120 kurze.\n\n"
