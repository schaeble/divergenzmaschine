...
export const BUILTIN_PRESETS: Record<string, Bank> = {
  ...
  "modernarchitecture": {
    ...
    "turns": [
      ...
      "ein Nachbargebäude nimmt das Licht",
    ...
    "obstacles": [
      ...
      "der Winter hält den Rohbau an",
      "die Fassade hält die Wärme nicht",
      "der Bauherr wechselt das Büro",
      "ein Denkmalschutz greift nachträglich",
    ...
    "endings": [
      ...
      "So übergibt man Schlüssel und geht.",
  ...
  "bureau": {
    "motifs": [
      ...
      "eine Uhr über dem Schalter, eine Minute vor"
    ],
    "hooks": [
  ...
  "dickens": {
    ...
    "hooks": [
      ...
      "Die Wärmestube hat heute geschlossen.",
    ...
    "obstacles": [
      ...
      "der Schuldturm nimmt keine Bürgschaft",
  ...
  "urknall": {
    ...
    "obstacles": [
      ...
      "die Zeit am Detektor läuft anders",
      "kein Vergleichswert liegt vor",
      "der Untergrund überdeckt das Signal",
      "die Rechnung braucht mehr Stellen",
      "die Beobachtungsnacht fällt aus",
      "zwei Kalibrierungen widersprechen sich",
      "es fehlt an Kühlmittel",
    ...
    "endings": [
      ...
      "Und der Schreiber zeichnet weiter, gleichmäßig.",
      "So bleibt die Lücke im Spektrum stehen.",
      "Am Morgen liegt die Platte im Bad.",
      "Und die Kurve läuft auseinander, wie erwartet.",
      "So kühlt es weiter, um Bruchteile.",
      "Und die nächste Nacht ist schon eingetragen."
    ]
  },
  "erotik": {
    "motifs": [
  ...
  "hafen": {
    "motifs": [
      ...
      "ein Fährplan mit übermalten Zeiten",
      ...
      "ein Schuppen mit offener Tür",
      "Möwen über einem leeren Kai",
      "ein Schiffsname unter neuer Farbe",
      "die Uhr am Zollhaus",
      "ein Steg, dem eine Planke fehlt",
      "Ölspuren in Regenbogenfarben",
  ...
  "alltag": {
    "motifs": [
      ...
      "ein Regenschirm im Schirmständer",
      "der Nachbarshund hinter der Tür",
      "Kaffeeflecken auf dem Antrag",
      "eine Glühbirne, die flackert",
      "der Sperrmüll vor dem Haus"
    ],
    "hooks": [
