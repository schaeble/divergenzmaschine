...
export const BUILTIN_PRESETS: Record<string, Bank> = {
  "rimbaud": {
    "motifs": [
      ...
      "ein Fluss, der ins Meer läuft und nicht zurück",
      "ein Schulheft, in dem etwas anderes steht als Latein",
      "eine Landstraße, die aus dem Ort hinausführt",
    ...
    "hooks": [
      ...
      "Der Fluss hat das Tau durchgescheuert, und niemand hält.",
      "Er ist am Morgen fort, und das Bett ist gemacht.",
      "Ein Gedicht liegt auf dem Tisch, ohne Anrede.",
      "Die Straße nach Norden ist offen, seit gestern.",
    ...
    "turns": [
      ...
      "die Freiheit kommt und lässt sich nicht aushalten",
      "er hört auf zu schreiben, mitten im besten Jahr",
      "der Fluss trägt ihn an einer Stadt vorbei, die er suchte",
      "ein Schuss fällt in einem Zimmer in Brüssel",
      "die Sprache reicht nicht, und er erfindet eine neue",
      "er kehrt heim und erkennt das Haus nicht wieder",
      "der Rausch geht vorbei und lässt einen Satz zurück",
      ...
      "er verkauft alles, auch die Bücher"
    ],
    "obstacles": [
      "die Strömung setzt jede Nacht in eine andere Richtung",
      ...
      "der Sturm hat kein Zentrum und hört nicht auf",
      "unsichtbare Netze hängen zwischen den Inseln",
      "die Flaute hält länger als der Vorrat an Wasser",
      "kein Wirt gibt einem Sechzehnjährigen ein Zimmer",
      "die Grenze verlangt Papiere, die er nicht hat",
      "der Freund will bleiben, wo er weg will",
      "das Geld kommt zu spät und in falscher Währung",
      "die Mutter schreibt und erwartet eine Antwort",
      "die Küste ist da und nicht zu erreichen",
      "das Fieber kommt mit dem Süden",
      "die Sprache des Landes hat keine Wörter dafür",
      "der Rückweg kostet mehr als der Hinweg",
      "die Zeitschriften drucken es nicht",
      "das Bein trägt nicht mehr bis zum Hafen"
    ],
    "stakes": [
      ...
      "Der Einsatz ist die Sprache, die er hinter sich lässt.",
      "Der Einsatz ist die Rückkehr, die niemand erwartet."
    ],
    "endings": [
      ...
      "Am Ende schreibt er über Preise und nicht über Sterne.",
      "Und der Fluss läuft ins Meer, wie immer.",
      "So endet die Reise in einem Zimmer mit Fenster zum Hof.",
      "Und die Sohlen halten noch bis zur Grenze.",
      "Der Brief kommt an, drei Monate später.",
      "Und niemand liest es, solange er lebt.",
      "So bleibt ein Satz übrig, und der genügt.",
      "Und die Straße nach Norden ist morgen auch noch offen."
    ],
    "verwandlungen": [
      "Boot→Blatt",
      "Fluss→Faden",
  ...
  "surrealismus1920": {
    "motifs": [
      ...
      "ein Café, in dem Sätze gewürfelt werden",
      ...
      "eine Uhr, die auf einem Ast hängt",
      "ein Zug, der in einem Wohnzimmer hält"
    ],
    "hooks": [
      ...
      "Die Tür ist gezeichnet und lässt sich öffnen.",
      "Ein Teilnehmer schläft, und die Sitzung geht weiter.",
      "Auf dem Tisch liegt ein Gegenstand, den keiner mitbrachte.",
      "Der Traum von gestern wird heute protokolliert.",
      "Zwei Sätze werden gefaltet und ergeben einen dritten.",
      "Die Ausstellung öffnet, und die Bilder hängen verkehrt.",
    ...
    "props": [
      ...
      "ein Manifest in fünf Fassungen",
      "eine Nähmaschine ohne Faden",
      "einen Spiegel, der nach unten hängt",
      "eine Kaffeetasse aus Fell"
    ],
    "turns": [
      "die Logik wechselt die Richtung und bleibt dabei gültig",
      "ein Gegenstand beginnt zu sprechen und wird dabei höflich",
      "die Szene wiederholt sich, aber mit anderem Wetter",
      "ein Name fällt aus dem Himmel",
      "die Wände werden durchlässig, aber nur in eine Richtung",
      "die Zeit wird zu einem Möbelstück und steht im Weg",
      ...
      "der Text schreibt sich weiter, als die Hand aufhört",
      "das Bild erklärt sich und verliert dabei alles",
      "zwei Dinge treffen sich, die einander nie sahen",
      "der Schlaf gilt plötzlich als Arbeit",
      "die Gruppe schließt jemanden aus und übernimmt seine Idee",
      "die Ausstellung wird ein Erfolg, und das ist die Niederlage",
      "ein Wort verliert seinen Gegenstand und wird frei",
      "der Raum tritt zurück, als jemand ihn betritt",
    ...
    "obstacles": [
      ...
      "ein Schatten läuft voraus und wartet an der Ecke",
      "die Uhr schmilzt in der Hand",
      "das Fenster weigert sich, hinauszuschauen",
      "die Tür führt in eine Zeichnung ohne Tiefe",
      "der Verleger will eine Erklärung im Vorwort",
      "die Polizei versteht das Manifest wörtlich",
      "der Zufall lässt sich nicht auf Bestellung herstellen",
      "zwei Fassungen des Textes sind gleich gut",
      "das Automatische wird mit der Zeit gekonnt",
      "ein Mitglied nimmt alles ernst",
      "die Galerie verlangt Titel für die Bilder",
      "der Traum ist beim Aufwachen schon geordnet",
      "die Gruppe streitet über einen Halbsatz",
    ...
    "stakes": [
      ...
      "Der Einsatz ist eine Gruppe, die einen Streit nicht übersteht.",
      "Der Einsatz ist der Zufall, der sich nicht wiederholen lässt.",
      "Der Einsatz ist eine Ausstellung, die keiner erklärt.",
    ...
    "endings": [
      ...
      "So bleibt der nasse Schlüssel als einziger Beweis.",
      "Am Ende hängt das Bild verkehrt, und es stimmt.",
      "Und beim Erwachen ist der Raum größer als vorher.",
      "So wird das Protokoll abgeheftet und nie gelesen.",
      "Und die Nähmaschine steht neben dem Regenschirm.",
      "Der Text hört auf, wo die Hand müde wurde.",
      "Und im Café bestellt jemand für einen Abwesenden.",
      "So schließt die Ausstellung, und niemand fragt nach.",
      "Und die gezeichnete Tür bleibt offen stehen.",
  ...
  "transzendenz": {
    "motifs": [
      ...
      "ein Raum, in dem das Echo länger bleibt als der Ton",
      "eine Schwelle, die man überschritten hat, ohne es zu merken",
      "eine Landschaft, die niemanden voraussetzt",
      "ein Wort, das sich beim Aussprechen auflöst",
      "ein Wasser, das keine Oberfläche hat",
      "ein Weg, der endet, ohne aufzuhören",
    ...
    "hooks": [
      ...
      "Der Atem geht weiter, und niemand führt ihn.",
      "Ein Gedanke kommt, und es ist keiner da, der denkt.",
      "Das Licht im Zimmer ändert sich ohne Grund.",
      "Die Frage steht im Raum und hat keinen Fragenden mehr.",
      "Jemand betet und merkt, dass er zuhört.",
    ...
    "props": [
      ...
      "eine Decke für die kalten Stunden",
    ...
    "turns": [
      ...
      "das Suchen hört auf, und es fehlt nichts",
      "was gesucht wurde, war die ganze Zeit das Suchen",
      "die Erfahrung kommt und lässt sich nicht behalten",
      "er will es beschreiben und macht es damit kleiner",
      "die Zeit steht nicht still, sie wird gleichgültig",
      "das Ich meldet sich zurück und stört nicht mehr",
      ...
      "ein Lehrer sagt nichts, und es genügt",
      "er kehrt in den Alltag zurück und bringt nichts mit",
      "ein gewöhnlicher Gegenstand steht plötzlich für sich allein",
      "die Angst vor dem Verschwinden verschwindet zuerst",
      "der Unterschied zwischen Hören und Gehörtwerden fällt weg",
    ...
    "obstacles": [
      ...
      "wer davon erzählt, hat es schon verlassen",
      "der Alltag beginnt am nächsten Morgen wieder",
      "ein Beweis würde alles zerstören",
      "die anderen wollen eine Erklärung hören",
      "das Gedächtnis macht daraus eine Geschichte",
      "wer es festhält, hält nur die Erinnerung",
      "die Übung gelingt nicht auf Verlangen",
      "der Zweifel kommt zuverlässig am dritten Tag",
      "es gibt kein Zeichen, an dem man es prüft",
      "das große Wort ist besetzt und steht im Weg",
      "der Tag hat zu viele Verabredungen für so etwas",
      "die Worte der anderen holen ihn sofort zurück",
      "ein Buch beschreibt es, und die Beschreibung stimmt nicht",
      "wer es sucht, hat es damit schon verstellt",
      "die Ruhe im Haus hält nur bis zum Mittag",
      "der Körper meldet sich nach der zweiten Stunde"
    ],
    "stakes": [
      ...
      "Der Einsatz ist die Frage, ob jemand zuhört.",
    ...
    "endings": [
      ...
      "Und der Atem geht weiter, ohne dass jemand ihn führt.",
      "So bleibt die Schale stehen, leer und voll.",
      "Und am Morgen beginnt der Alltag pünktlich.",
      "Der Weg hört auf, und niemand ist angekommen.",
      "Und das Wort bleibt ungesagt und stimmt.",
      "So bleibt es dabei: Es war und lässt sich nicht sagen.",
      "Und die Bank an der Mauer steht am nächsten Tag noch.",
  ...
  "formalismus": {
    "motifs": [
      ...
      "ein Regelwerk, das seine eigene Änderung regelt",
      "eine Definition, die auf eine zweite verweist",
      "ein Paragraph mit drei Absätzen und vier Ausnahmen",
      "eine Fußnote, die den Haupttext aufhebt",
      "ein Formblatt, dessen Felder einander ausschließen",
      "ein Kommentar, der länger ist als das Gesetz",
    ...
    "hooks": [
      ...
      "gemäß Regel 3.2 ist der Fall nicht vorgesehen",
      "die Ordnung gilt, und niemand weiß mehr wofür",
      "es wird festgestellt, was ohnehin niemand bestritten hat",
      "die Zuständigkeit ist geklärt und liegt bei niemandem",
      "ein Protokoll beginnt mit einem Satz aus einem anderen Fall",
      "der Vorgang wird eröffnet, bevor der Antrag da ist",
      "Absatz zwei widerspricht Absatz eins, seit der Änderung.",
      ...
      "Ein Verweis führt auf eine Vorschrift ohne Text.",
      ...
      "Die Unterschrift fehlt, und der Vorgang läuft weiter."
    ],
    "props": [
      "ein Dokument",
      "eine Akte",
      ...
      "einen Stempel für die Gültigkeit",
      "ein Verzeichnis der Änderungen",
      "eine Fußnote auf einem eigenen Blatt",
      "einen Vermerk in roter Tinte"
    ],
    "turns": [
      "die Regel widerspricht sich selbst und bleibt in Kraft",
      "ein Absatz wird gestrichen und in der Fußnote fortgeführt",
      "die Definition verschiebt ihre Bedeutung von Fassung zu Fassung",
      "die Hierarchie kippt, und die Fußnote steht oben",
      "die Klausel wird wörtlich genommen und dadurch unbrauchbar",
      "die Ausnahme wird zur Norm und behält ihren Namen",
      "ein Verweis führt ins Leere und wird trotzdem zitiert",
      "die Ausnahme wird häufiger angewendet als die Regel",
      "der Kommentar wird zur eigentlichen Vorschrift",
      "eine Lücke wird geschlossen und öffnet zwei neue",
      "die Auslegung ändert sich, ohne dass sich der Text ändert",
      "der Fall passt genau und ist trotzdem nicht gemeint",
      "die Form ist gewahrt, und die Sache geht verloren",
      "ein Verweis führt im Kreis, und niemand merkt es",
      "die Änderung gilt ab einem Datum in der Vergangenheit",
      "zwei Instanzen legen denselben Satz gegensätzlich aus",
      "die Ordnung hält, weil niemand sie prüft",
      ...
      "der Prüfer beanstandet die Form und lobt die Sache",
      "eine Vorschrift wird aufgehoben und weiter angewendet",
      "die Loseblattsammlung ist auf dem Stand von 1998"
    ],
    "obstacles": [
      "die Zuständigkeit ist unklar und wird nicht geklärt",
      "ein Dokument fehlt, und ohne es geht nichts weiter",
      "die Signatur ist ungültig, seit die Vorschrift geändert wurde",
      "ein Absatz ist doppeldeutig, und beide Lesarten sind zulässig",
      "die Definition ist nicht abschließend und gilt trotzdem",
      ...
      "die Begründung darf nicht mitgeteilt werden",
      "der Kommentar ist vergriffen",
      "zwei Regeln gelten gleichzeitig und schließen sich aus",
      "die Auslegung ist strittig und wird nicht entschieden",
      "das Verzeichnis ist auf dem Stand von vorletztem Jahr",
      "die Änderung wurde beschlossen und nicht veröffentlicht",
      "wer fragt, löst eine Prüfung aus",
      "die Änderung liegt bei, ist aber nicht eingeheftet",
      "niemand weiß, welche Fassung im Streitfall gilt",
      "das Formblatt verlangt zwei Angaben, die sich ausschließen",
      "die Zuständigkeit wechselt mit dem Anfangsbuchstaben",
      "die Frist ist gewahrt und der Antrag trotzdem verspätet",
      "der Vordruck ist vergriffen und wird neu gedruckt"
    ],
    "stakes": [
      "Der Einsatz ist die Gültigkeit einer einzigen Unterschrift.",
      "Der Einsatz ist die Eindeutigkeit eines Satzes, den viele lesen.",
      "Der Einsatz ist eine Ordnung, die niemand einzeln prüfen kann.",
      "Der Einsatz ist die Ordnung, die an einer Fußnote hängt.",
      "Der Einsatz ist eine Frist, die schon begonnen hat.",
      "Der Einsatz ist ein Begriff und was er ausschließt.",
    ...
    "endings": [
      ...
      "Und der Kommentar wird um einen Absatz ergänzt.",
      "So gilt die Regel weiter, gegen ihren Wortlaut.",
      "Und die Fußnote überlebt den Haupttext.",
      "Der Vermerk kommt zu den Akten, in roter Tinte.",
      "Und niemand ändert, was sich eingespielt hat.",
      "So bleibt der Verweis im Kreis, gültig.",
      "Und die nächste Fassung erscheint im Frühjahr.",
      "Und die Registratur legt den Vorgang unter R ab.",
      "So bleibt das Formblatt unausgefüllt in der Mappe.",
      "Am Ende trägt der Stempel ein Datum und keinen Namen.",
      "Und die Loseblattsammlung wächst um vier Blatt."
    ],
    "verwandlungen": [
      "Regel→Gewohnheit",
      "Akte→Mappe",
  ...
  "koran": {
    "motifs": [
      ...
      "ein Hof, in dem fünfmal am Tag Wasser läuft",
      "eine Handschrift, deren Ränder Gold tragen",
      "eine Karawane, die vor Sonnenaufgang aufbricht",
      "ein Brunnen, der eine Stadt getragen hat",
      "eine Stimme, die einen Vers trägt, ohne ihn zu lesen",
      "ein Datum, das jedes Jahr elf Tage wandert",
      "eine Nische, die nach Süden zeigt",
      "ein Schatten, der zur Gebetszeit die Länge wechselt"
    ],
    "hooks": [
      ...
      "Die Karawane bricht auf, und einer bleibt zurück.",
      "Ein Gast kommt, und die Vorräte reichen nicht für drei Tage.",
      "Der Schatten steht falsch für diese Jahreszeit.",
      "Jemand bittet um eine Auskunft, die niemand geben darf.",
      "Der Lehrer schweigt an einer Stelle, die er sonst erklärt.",
      "Ein Schreiber lässt ein Wort aus und merkt es zu spät."
    ],
    "props": [
      "einen Gebetsteppich",
      "eine Gebetskette",
      ...
      "eine Schale mit Wasser für den Gast",
      "ein Blatt mit Goldrand",
      "eine Rohrfeder und ein Tintenfass",
      "einen Krug für die Waschung",
      "ein Bündel Datteln für den Weg",
    ...
    "turns": [
      ...
      "ein Vers verändert die Richtung eines ganzen Tages",
      "die Waage neigt sich, und niemand hat sie berührt",
      "das Herz wird zum Richter über die Auskunft",
      "der Gast erweist sich als der, den man suchte",
      "die Geduld reicht bis zum letzten Tag der Prüfung",
      "ein Wort wird ausgelassen und ändert den Sinn nicht",
      "die Karawane kehrt um, und das rettet sie",
      "der Lehrer gibt zu, dass er es nicht weiß",
      "ein Schuldner wird entlassen, und niemand erfährt es",
      "der Brunnen gibt wieder, nach vier Tagen",
      "die Antwort steht im Buch und wird anders gelesen",
      "ein Streit endet, weil einer zuerst grüßt",
      "der Weg ist schmal und wird an einer Stelle breit",
      "die Prüfung kommt ohne Warnung und geht ohne Erklärung",
      "ein Vers, der oft gelesen wurde, meint heute etwas anderes",
      "der Schreiber setzt das Wort ein und lässt den Rand frei"
    ],
    "obstacles": [
      ...
      "der Brunnen ist versandet, der nächste zwei Tage entfernt",
      "die Karawane wartet nicht auf einen einzelnen",
      "die Schrift ist an drei Stellen verblasst",
      "der Gast bleibt länger, als die Vorräte reichen",
      "der Sommer macht den Weg tagsüber unbegehbar",
      "die Auskunft würde einen anderen beschämen",
      "das Kamel ist lahm, und der Markt ist weit",
      "niemand darf zwischen den beiden vermitteln",
      "die Nacht ist kurz, und der Ruf kommt früh",
      "der Schreiber hat kein Gold mehr für die Ränder",
      "die Antwort ist bekannt und hilft dem Fragenden nicht",
      "eine Prüfung kommt ohne Warnung und ohne Frist",
      "der Weg über die Salzebene ist nur nachts begehbar",
      "die Handschrift gehört einem Haus, das sie nicht ausleiht"
    ],
    "stakes": [
      ...
      "Der Einsatz ist der Brunnen für eine ganze Stadt.",
      "Der Einsatz ist ein Wort, das jemanden beschämen würde."
    ],
    "endings": [
      ...
      "Und die Wüste trägt nach dem Regen plötzlich Grün.",
      "So findet das Herz seine Richtung wieder.",
      "Am Ende bleibt der Vers, und der Tag geht weiter.",
      "Und der Brunnen gibt Wasser, für dieses Jahr.",
      "So bricht die Karawane vor Sonnenaufgang auf.",
      "Und der Gast zieht weiter, mit Datteln für den Weg.",
      "Der Schatten steht wieder da, wo er stehen soll.",
      "Und das Blatt trocknet mit Goldrand.",
      "So bleibt die Stelle unerklärt bis zum nächsten Jahr.",
      "Und im Hof läuft das Wasser wie immer.",
      "Und im Hof wird der Teppich ausgeschüttelt.",
      "So bleibt die Karawane bis zum Morgen am Brunnen.",
      "Am Ende ist die Schale wieder gefüllt für den Nächsten."
    ],
    "verwandlungen": [
      "Brunnen→Spiegel",
      "Vers→Faden",
  ...
  "erotik": {
    "motifs": [
      ...
      "ein Mantel, der über einer fremden Lehne hängt",
      "ein Fenster, das jemand geöffnet hat",
      "eine Treppe, auf der zwei gleichzeitig stehen bleiben",
      "ein Glas, das zweimal gefüllt wurde",
      "ein Zimmer mit einer Tür, die nicht abschließt",
      "eine Uhr, die niemand ansieht",
      "ein Name, der leiser gesagt wird als nötig"
    ],
    "hooks": [
      ...
      "Der Stuhl rückt näher, ohne dass jemand ihn zieht.",
      "Sie schweigen, und das Schweigen wird eine Antwort.",
      "Er reicht ihr das Glas und lässt nicht sofort los.",
      "Die anderen gehen, und keiner von beiden steht auf.",
      "Ein Satz bricht ab, weil er zu weit gegangen wäre.",
      "Die Tür bleibt angelehnt, und niemand schließt sie.",
      "Sie lacht an einer Stelle, an der nichts komisch war.",
      "Der Mantel bleibt über der Lehne bis zum Morgen."
    ],
    "props": [
      "ein Glas Wein",
      "ein offenes Fenster",
      ...
      "einen Spiegel",
      "einen Brief",
      "ein Glas Wein, zweimal gefüllt",
      "ein Seidenband vom Handgelenk",
      "einen Mantel über einer fremden Lehne",
      "einen Schlüssel, der auf dem Tisch liegt",
      "eine Uhr, die abgelegt wurde",
      "einen Zettel mit einer Zeit darauf",
      "eine Decke über zwei Stuhllehnen",
    ...
    "turns": [
      ...
      "aus Höflichkeit wird Absicht, in einem einzigen Satz",
      "die Regel wird ausgesprochen und dadurch verhandelbar",
      "sie sagt nein und meint einen anderen Abend",
      "die Berührung war zufällig und wird es nicht bleiben",
      "der Vorsatz hält bis zur Tür",
      "er fragt und macht es dadurch möglich",
      "die Nacht wird länger, ohne dass jemand sie verlängert",
      "ein Blick geht zu weit und wird nicht zurückgenommen",
      ...
      "das Gespräch wechselt das Thema und meint dasselbe",
      "jemand sagt die Wahrheit und tut so, als wäre es ein Scherz",
      "die Musik hört auf, und keiner steht auf",
      "die Verabredung für morgen ist die Antwort von heute",
    ...
    "obstacles": [
      ...
      "das Wort dafür fehlt, in dieser Sprache",
      "morgen sehen sich beide bei der Arbeit",
      "der Vorsatz war ausdrücklich und laut",
      "ein Anruf kommt zur falschen Minute",
      "die Tür geht auf, und jemand sucht seinen Mantel",
      "die Nüchternheit kommt vor der Entscheidung",
      "der andere ist zu höflich für eine Antwort",
      "es müsste jemand fragen, und keiner tut es",
      "die Nachbarn hören jedes Wort durch die Wand",
      "das Taxi steht schon unten und wartet",
      "einer von beiden ist morgen früh weg",
      "die Wohnung gehört jemandem, der zurückkommt",
      "es gibt keinen Grund, noch länger zu bleiben",
      "ein Kollege sitzt zwei Tische weiter",
      "die Erklärung würde alles kaputtmachen"
    ],
    "stakes": [
      ...
      "Der Einsatz ist eine Freundschaft von zwölf Jahren.",
    ...
    "endings": [
      ...
      "So bleibt die Frage stehen, bis zum nächsten Mal.",
      "Und niemand hat etwas gesagt, den ganzen Abend.",
      "Der letzte Zug fährt, und beide bleiben stehen.",
      "Und das Fenster bleibt offen bis zum Morgen.",
      "So endet der Abend, und es ist etwas geschehen.",
      "Und am Montag grüßen sich beide wie immer.",
      ...
      "Und die Treppe hört auf, und niemand geht weiter.",
  ...
  "romantik": {
    "motifs": [
      ...
      "ein Spiegel in einem Zimmer ohne Möbel",
    ...
    "hooks": [
      ...
      "Die blaue Blume steht am falschen Ort und blüht.",
      ...
      "Ein Fremder kennt die Geschichte besser als der Erzähler.",
      "Das Buch schlägt sich bei derselben Seite auf.",
      "Ein Brief kommt an, den er im Traum gelesen hat.",
      "Der Weg durch den Wald ist kürzer als gestern.",
    ...
    "turns": [
      ...
      "das Lied kennt die Zukunft und singt sie beiläufig",
      "die Blume verliert im Licht ihre Farbe und nicht ihren Sinn",
      "der Erzähler wird zur Figur der eigenen Geschichte",
      "ein Märchen erklärt, was keine Auskunft erklärt",
      "der Berg gibt etwas zurück, das lange fehlte",
      "die Kindheit kommt wieder, aber als Fremde",
      "die Ruine trägt ein Zeichen, das frisch ist",
      "der Spiegel zeigt eine Zeit und nicht einen Ort",
      "das Buch endet mitten im Satz und ist vollständig",
      "die Nacht erklärt, was der Tag verschwiegen hat",
      "ein Freund erkennt ihn und nennt ihn anders",
      "eine alte Frau nennt den Namen der blauen Blume",
      "die Sehnsucht findet ihr Ziel und hört nicht auf",
      "ein Bild an der Wand zeigt eine Landschaft, die er kennt",
      "die Nacht bringt eine Antwort, die der Tag nicht gab",
      "der Fremde geht, und der Weg ist plötzlich beschrieben",
      "das Bergwerk gibt ein Stück Erz mit einer Zeichnung"
    ],
    "obstacles": [
      ...
      "das Erwachen kommt zu früh, an jedem Morgen",
      "niemand sonst hört den Ton aus dem Berg",
      "der Weg durch den Wald ist bei Tag nicht zu finden",
      "die fehlende Seite lässt sich nirgends beschaffen",
      "die Ruine gehört einem Gut, das keinen Besuch duldet",
      "das Lied lässt sich nicht aufschreiben",
      "der Winter schließt den Pass bis zum Frühjahr",
      ...
      "die Kerze im Fenster brennt für jemand anderen",
      "die Kutsche fährt nur bis zum letzten Dorf",
      "das Bergwerk ist seit dem Frühjahr geschlossen",
      "der Wirt kennt die Geschichte und erzählt sie falsch",
      "die Locke im Medaillon gehört jemand anderem",
      "niemand im Ort erinnert sich an das Haus",
      "der Mond steht in diesem Monat zu tief",
      "der Erzähler bricht ab, wo es wichtig wird"
    ],
    "stakes": [
    ...
    "endings": [
      ...
      "Und in der Ruine kühlt die Asche aus.",
      "So bleibt die Seite fehlen, und das Buch stimmt.",
      "Und im Fenster brennt die Kerze bis zum Morgen.",
      "Der Berg singt weiter, für niemanden.",
      "Und der Waldweg ist am Tag nicht mehr zu finden.",
      "So schließt sich der Traum über dem Zimmer.",
      "Und niemand fragt, was er dort gesucht hat.",
      "Am Ende trägt er die Blume im Buch nach Hause.",
      "Und der Fremde ist am nächsten Morgen weitergegangen.",
      "Und im Bergwerk wird es still, nach dem letzten Ton.",
      "So bleibt die Landschaft im Traum, wo sie hingehört.",
      "So endet das Märchen, und die Geschichte fängt an."
    ],
    "verwandlungen": [
      "Blume→Narbe",
      "Traum→Bericht",
  ...
  "sinnlich": {
    "motifs": [
      ...
      "eine Frucht, die im Mund kälter wird",
      "ein Geräusch, das man auf der Haut spürt",
      "ein Licht, das die Farben verschiebt",
      "ein Boden, der unter den Füßen warm bleibt",
    ...
    "hooks": [
      ...
      "Die Haut spürt ein Geräusch, bevor das Ohr es hört.",
      "Ein Geschmack ruft ein Datum auf, das niemand nannte.",
      "Der Stoff fühlt sich anders an als gestern.",
    ...
    "turns": [
      ...
      "die Berührung verändert die Farbe des Ganzen",
      "das Ohr hört auf, und die Haut hört weiter",
      "ein Geschmack ordnet die Erinnerung neu",
      "die Wärme bleibt länger als die Hand",
      "das Licht wechselt, und der Raum wird ein anderer",
      "was weich war, wird unter der Hand kalt",
      "der Ton hört auf, und die Stille hat eine Farbe",
      "ein Duft nimmt einen ganzen Nachmittag ein",
      "die Sprache kommt zu spät und macht es kleiner",
      "die Haut merkt sich, was der Kopf vergisst",
      "eine Berührung wird zur Auskunft",
      "das Auge macht den Fehler, den die Hand nicht macht",
      "die Zunge findet ein Wort, das die Hand schon kannte",
      "der Raum wird kleiner, sobald das Licht sich ändert",
      "ein Geräusch aus dem Hof ordnet den ganzen Nachmittag",
      "die Kälte kommt später als erwartet und bleibt länger",
      "der Stoff gibt nach und behält den Abdruck",
      "ein Geschmack kippt von süß nach bitter, in der Mitte",
    ...
    "obstacles": [
      ...
      "die Erkältung nimmt zwei Sinne auf einmal",
      "der Stoff ist nur in einem Laden zu bekommen",
      "die Erinnerung an den Geruch stimmt nicht",
      "die Wärme hält nur bis zum Abend",
      "ein Ton übertönt alles andere im Haus",
      "die Frucht ist außerhalb der Saison",
      "die Hand ist zu kalt für diesen Stoff",
      "die Kerze brennt nur eine Stunde",
      "man kann es nicht zweimal zum ersten Mal riechen",
      "die Beschreibung macht das Gefühl kaputt",
      "das Fenster lässt sich in diesem Zimmer nicht öffnen",
      "der Laden hat die Seide nicht mehr im Sortiment",
      "die Nachbarn kochen etwas, das alles überdeckt",
      "der Stein kühlt aus, bevor jemand kommt",
      "das Wasser ist zu heiß und dann zu kalt",
    ...
    "stakes": [
      ...
      "Der Einsatz ist die Frage, ob ein anderer es auch spürt.",
    ...
    "endings": [
      ...
      "So bleibt die Wärme an der Stelle, für kurze Zeit.",
      "Und die Schale steht leer auf dem Tisch.",
      "Am Ende bleibt ein Geschmack und kein Wort dafür.",
      "Und das Licht wandert weiter über den Boden.",
      ...
      "So bleibt der Abdruck im Stoff, bis jemand ihn glättet."
    ],
    "verwandlungen": [
      "Duft→Verdacht",
      "Haut→Rinde",
