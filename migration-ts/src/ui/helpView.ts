...
export function mountHelp(root: HTMLElement): void {
  ...
  wrap.append(section("tabs", "Tabs — die App im Überblick", [
    ...
    ["Wortbank", P("Das Material-Herz: Presets laden, Auto-Mix, Regeln-Box (wie Einträge zu schreiben sind), „Preset bearbeiten und sichern“ als Editor aller 7 Kategorien (Motive, Haken, Requisiten, Wendungen, Hindernisse, Einsätze, Schlüsse), Mutation, Preset-Assistent und Wortarchiv (KI oder Einfügen, in Gruppen), JSON-Import/Export, „Als Preset speichern“. „Per KI aktualisieren“ verbessert das aktive Preset (einzeln oder im Stapel); die ", lnk("Preset-2.0-Felder", "preset2"), " ergänzen den dramaturgischen Überbau. Unten aufklappbar die KI-Wortbank aus 4W plus Zusatzvorgabe.")],
