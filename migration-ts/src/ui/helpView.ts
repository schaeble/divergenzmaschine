...
export function mountHelp(root: HTMLElement): void {
  ...
  wrap.append(section("tabs", "Tabs — die App im Überblick", [
    ...
    ["Wortbank", P("Das Material-Herz: Presets laden, Auto-Mix, Regeln-Box (wie Einträge zu schreiben sind), Listen-Editor der 7 Kategorien (Motive, Haken, Requisiten, Wendungen, Hindernisse, Einsätze, Schlüsse), Mutation, JSON-Import/Export, „Als Preset speichern“. „Per KI aktualisieren“ verbessert das aktive Preset (einzeln oder im Stapel); die ", lnk("Preset-2.0-Felder", "preset2"), " ergänzen den dramaturgischen Überbau. Unten aufklappbar die KI-Wortbank aus 4W plus Zusatzvorgabe.")],
  ...
  wrap.append(section("presetton", "Preset · Ton · Form", [
    ["Preset", P("die aktive ", lnk("Wortbank", "tabs"), " (eingebaut oder eigene). Beim Start zufällig gewählt; Wechsel lädt die Wortbank sofort.")],
